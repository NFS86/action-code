...
class MirrorListener:
    ...
    def onDownloadError(self, error):
        ...
        msg = f"<b>Hai {self.tag} ✨\n\nYour Download Has Been Stopped. Because {error}</b> "
...
def _mirror(bot, message, isZip=False, extract=False, isQbit=False, isLeech=False, pswd=None, multi=0, qbsd=False):
    ...
    if FSUB:
        try:
            ...
            if user.status not in ['member', 'creator', 'administrator']:
                buttons.buildbutton("⚙️ JOIN HERE ⚙️", f"https://t.me/{CHANNEL_USERNAME}")
    ...
    if not is_url(link) and not is_magnet(link) and not ospath.exists(link):
        ...
        help_msg += "\n<b>Example :</b>"
        help_msg += "\n<code>/mirror https://drive.hilmay619.workers.dev/0:/1%20-%20Example/open_gapps-arm64-11.0-pico-20220503.zip</code>"
        help_msg += "\n\n<b>🚩How to Mirror With Custom Name?</b>"
        help_msg += "\n<code>/command</code> {Link} |{New Name}"
        help_msg += "\n<b>Note : Add | Before Link</b>"
        help_msg += "\n<b>Example :</b>"
        help_msg += "\n<code>/mirror https://drive.hilmay619.workers.dev/0:/1%20-%20Example/open_gapps-arm64-11.0-pico-20220503.zip |X.zip</code>"
        help_msg += "\n\n<b>🚩How to Mirror With Unzip Mirror / Extract With Password?</b>"
        help_msg += "\n<code>/command</code> {Link} |pswd: {Your Password}"
        help_msg += "\n<b>Example :</b>"
        help_msg += "\n<code>/unzipmirror https://drive.hilmay619.workers.dev/0:/1%20-%20Example/Wallpapers.zip |pswd: qwerty123</code>"
        help_msg += "\n\n<b>🚩How to Mirror With qBitTorrent?</b>"
        help_msg += "\n<b>Example :</b>"
        help_msg += "\n<code>/qbmirror https://yts.mx/torrent/download/063A8D1602B018CEF86F34FF540D69D29F46CBBA</code>"
        help_msg += "\n\n<b>🚩How to Mirror Seeding & Selection File With qBitTorrent?</b>"
        help_msg += "\n<b>Note : Add s / d After Command</b>"
        help_msg += "\n<b>Example :</b>"
        help_msg += "\n<b>- For Selection Files</b>"
        help_msg += "\n<code>/qbmirror s https://yts.mx/torrent/download/063A8D1602B018CEF86F34FF540D69D29F46CBBA</code>"
        help_msg += "\n\n<b>- For Seeding Files</b>"
        help_msg += "\n<code>/qbmirror d https://yts.mx/torrent/download/063A8D1602B018CEF86F34FF540D69D29F46CBBA</code>"
